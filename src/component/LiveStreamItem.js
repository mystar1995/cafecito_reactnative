...
export default function LiveStreamItem({livestream})
{
    return (
        <View style={{width:wp('23.18'),marginRight:14}}>
            <ImageBackground source={{uri:config.apiurl + "/" + livestream.coverimage}} style={{width:wp('23.18'),height:wp('33.57'),flexDirection:'column',borderRadius:10,overflow:'hidden'}} resizeMode="cover">
