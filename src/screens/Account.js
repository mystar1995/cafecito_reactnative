                    ...
                    <ScrollView style={{flex:1}} showsVerticalScrollIndicator={false}>
                        <View style={{marginTop:24,marginBottom:48}}>
                            ...
                            <TouchableOpacity style={style.inputcontainer} onPress={()=>navigation.navigate('Email')}>
                                <Text style={style.title}>{userinfo.email}</Text>
                                ...
                                userinfo.role == 'influencer' && (
                                    <TouchableOpacity style={style.inputcontainer}>
                                        ...
                                        <Switch 
                                            ...
                                            onValueChange={value=>updatesetting("direct_chat",value)}
                                            value={userinfo.direct_chat?true:false}
                                        ></Switch>
                                    </TouchableOpacity>
                                )
                            }
                            <TouchableOpacity style={style.inputcontainer}>
                                ...
                                <Switch 
                                    ...
                                    value={userinfo.share_location?true:false}
                                ></Switch>
                            </TouchableOpacity>
                            <TouchableOpacity style={style.inputcontainer}>
                                ...
                                <Switch 
                                    ...
                                    value={userinfo.notification?true:false}
                                ></Switch>
                            </TouchableOpacity>
