        ...
        >
            <View style={style.container}>
                <View style={style.header}>
                    ...
                    <Text style={style.title}>{userinfo.role == 'influencer'?'My Videos':'Videos'}</Text>
                    ...
                    <View style={{display:'flex',flexDirection:'row',justifyContent:'space-between',flexWrap:'wrap'}}>
                        {
                            video.map((item,index)=>(
                                <VideoDetail {...item} key={index} navigation={navigation} me={userinfo.role == 'influencer'} setloading={setloading}></VideoDetail>
                            ))
                        }
                    </View>
                </ScrollView>
