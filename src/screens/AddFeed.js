...
import {addfeedurl} from '../service/podcastservice'
...
export default function AddFeed({navigation})
{
    ...
    const submitfeedurl = () => {
        addfeedurl(feedurl,token).then(res=>{
            if(res.data.success)
            {
                navigation.navigate('PodcastDetail',{id:res.data.id})
            }
                ...
                <View style={{marginBottom:24}}>
                    ...
                    <View style={{marginTop:24,marginBottom:48}}>
                        ...
                        <View style={style.inputcontainer}>
                            <TextInput style={[style.title,{flex:1}]} placeholderTextColor="white" placeholder="Feed URL" value={feedurl} onChangeText={setfeedurl}></TextInput>
                        </View>
                        <TouchableOpacity style={style.save_btn} onPress={submitfeedurl}>
