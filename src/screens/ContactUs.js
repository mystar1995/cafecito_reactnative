...
import {getsetting} from '../service/postservice'
                        ...
                        <View>
                            <View style={style.content}>
                                <View>
                                    ...
                                    <View style={style.inputcontainer}>
                                        <TextInput style={style.input} placeholderTextColor="#A2A2A2" defaultValue={contactinfo.phone}></TextInput>
                                    </View>
                                </View>
                                <View>
                                    <Text style={style.label}>By Mail:</Text>
                                    <View style={style.inputcontainer}>
                                        <TextInput style={style.input} placeholderTextColor="#A2A2A2" defaultValue={contactinfo.address} multiline={true}></TextInput>
                                    </View>
                                </View>
                                <View>
                                    <Text style={style.label}>By Email:</Text>
                                    <View style={style.inputcontainer}>
                                        <TextInput style={style.input} placeholderTextColor="#A2A2A2" defaultValue={contactinfo.email}></TextInput>
                                    </View>
                                </View>
                            </View>
                            <View style={style.form}>
                                ...
                                <View style={{marginTop:10}}>
                                    ...
                                    <View style={style.inputcontainer}>
                                        <TextInput style={style.input} placeholderTextColor="#A2A2A2" defaultValue={message.subject} onChangeText={text=>setmessage({...message,subject:text})}></TextInput>
                                    </View>
                                </View>
                                <View style={{marginTop:10}}>
                                    <Text style={style.label}>Comment</Text>
                                    <View style={style.inputcontainer}>
                                        <TextInput style={style.input} placeholderTextColor="#A2A2A2" defaultValue={message.message} multiline={true} numberOfLines={5} textAlignVertical="top" onChangeText={text=>setmessage({...message,message:text})}></TextInput>
                                    </View>
                                </View>
