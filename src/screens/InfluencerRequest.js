...
import {changerequest} from '../service/userservice'
...
export default function InfluencerRequest({navigation})
{
    ...
    const updaterequest = (id,status) => {
        setloading(true)
        changerequest(token,id,status).then(res=>{
            setupdate(!update)
        ...
        >
            <View style={style.container}>
                <View style={style.header}>
                    ...
                    <TouchableOpacity style={style.righticon} onPress={()=>setupdate(!update)}>
                ...
                <FlatList
                    ...
                    renderItem={({item,index})=>(
                        <InfluencerRequestItem request={item} key={index} onrequest={state=>updaterequest(item.id,state)}></InfluencerRequestItem>
                    )}
                ></FlatList>
