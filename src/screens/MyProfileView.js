                ...
                <ScrollView style={{marginTop:15}}>
                    <View style={{marginBottom:15}}>
                        <View style={[style.profileimg,{alignSelf:'center'}]}>
                            <Image source={userinfo.profile?{uri:config.apiurl + "/" + userinfo.profile}:require('../assets/images/darkmode/carp.png')} style={style.profileimg}></Image>
                        </View>
                        <View style={{margin:39,marginBottom:0}}>
                            <View>
                                <Text style={style.label}>Full Name:</Text>
                                <Text style={style.labelinfo}>{userinfo.fullname}</Text>
                            </View>
                            <View>
                                <Text style={style.label}>User Name:</Text>
                                <Text style={style.labelinfo}>{userinfo.username}</Text>
                            </View>
                            <View>
                                <Text style={style.label}>Bio:</Text>
                                <Text style={style.labelinfo}>{userinfo.bio}</Text>
                            </View>
                            <View>
                                <Text style={style.label}>Address:</Text>
                                <Text style={style.labelinfo}>{userinfo.address}</Text>
                            </View>
                            <View>
                                <Text style={style.label}>Birthday:</Text>
                                <Text style={style.labelinfo}>{userinfo.birthdate}</Text>
                            </View>
                        </View>
